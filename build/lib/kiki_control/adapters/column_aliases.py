...
ALIAS_COLUMNAS_MERCADO_LIBRE_VENTAS = MappingProxyType({})

_ALIAS_POR_FUENTE = MappingProxyType(
    {
        TipoFuente.ECCOMAPP_RENTABILIDAD: ALIAS_COLUMNAS_MERCADO_LIBRE,
        TipoFuente.MERCADO_LIBRE: ALIAS_COLUMNAS_MERCADO_LIBRE,
        TipoFuente.MERCADO_LIBRE_VENTAS: ALIAS_COLUMNAS_MERCADO_LIBRE_VENTAS,
