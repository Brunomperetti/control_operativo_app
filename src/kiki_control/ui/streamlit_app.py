...
def _column_config_control_consolidado() -> dict[str, Any]:
    return {
        ...
        "Neto aprobado MP": st.column_config.TextColumn("Neto aprobado bruto MP", width="medium", help="Suma bruta de pagos aprobados; se conserva para auditoría y no es la base de la diferencia financiera final."),
        ...
        "Diferencia ML–MP": st.column_config.TextColumn("Diferencia financiera MP − ML", width="medium", help="Neto financiero total MP menos Total (ARS) de ML oficial."),
