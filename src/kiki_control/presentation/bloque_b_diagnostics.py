...
def diagnosticar_bloque_b(
    ...
    for r in diferencias_r:
        ...
        grupos_con_dif.append(GrupoConDiferencia(
            ...
            impacto_reclamos_disputas_mp=r.impacto_reclamos_disputas_mp,
            impacto_devoluciones_mp=r.impacto_devoluciones_mp,
            impacto_pagos_envio_mp=r.impacto_pagos_envio_mp,
            impacto_otros_mp=r.impacto_otros_mp,
