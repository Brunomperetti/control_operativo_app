...
def _escribir_casos_ml_eccomapp(ws: Worksheet, cases) -> None:
    ws.append(["Grupo u orden", "IDs venta ML", "IDs orden Eccomapp", "Estado", "Aptitud utilidad", "Fecha", "Filas originales ML", "Filas originales Eccomapp", "Ingresos productos ML", "Ingresos envío ML", "Cargos e impuestos ML", "Costos envío ML", "Anulaciones/reembolsos ML", "Total informado ML", "SKU/publicación ML", "Importe venta Eccomapp", "Costo Eccomapp", "Utilidad informada Eccomapp", "Motivo", "Acción recomendada", "Estado técnico", "Aptitud técnica"])
    for c in cases:
